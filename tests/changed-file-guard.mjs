...
export const personalVisualHarmonyTriangleMediansChangedFiles = Object.freeze([
  "docs/examples/personal-chatgpt-visual-harmony-demo.md",
  "src/mcp/personal-visual-harmony-app.ts",
  "src/personal-visual-harmony-constructions.ts",
  "src/personal-visual-harmony.ts",
...
export const personalVisualHarmonyAngleBisectorsChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "src/personal-visual-harmony-constructions.ts",
  "src/personal-visual-harmony.ts",
  "tests/changed-file-guard.mjs",
...
export const personalVisualHarmonyPostPr240TruthClosureChangedFiles = Object.freeze([
...
export const personalVisualHarmonyConfirmationValidationFixChangedFiles = Object.freeze([
  "src/personal-visual-harmony-constructions.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/controlled-live-provider-smoke-artifact-proof.test.mjs",
...
export const personalVisualHarmonyAxisMeasurementRatioChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "src/personal-visual-harmony.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
...
export const personalVisualHarmonyMeasurementRatioClarityChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/personal-visual-harmony-mcp.test.mjs",
...
export const personalVisualHarmonySam3ModalPerceptionChangedFiles = Object.freeze([
...
export const privateWebLabResultPresentationChangedFiles = Object.freeze([
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/private-web-lab-browser.test.mjs",
  "web-lab/index.html",
...
export const personalVisualHarmonyTwoObjectSpatialChangedFiles = Object.freeze([
  "README.md",
  "src/mcp/personal-visual-harmony-app.ts",
  "src/personal-visual-harmony-perception-jobs.ts",
  "src/personal-visual-harmony-perception.ts",
...
// Covers the standard UI metadata contract, app-only tool decoupling, template
// cache-busting, legacy ChatGPT Apps SDK MIME compatibility, and stale aliases.
...
export const personalVisualHarmonyManualSegmentChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/personal-visual-harmony-mcp.test.mjs",
...
export const personalVisualHarmonyRepeatGuideEditingChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/personal-visual-harmony-mcp.test.mjs",
...
export const personalVisualHarmonyLineEnvelopeCanonicalizationChangedFiles = Object.freeze([
  "src/mcp/personal-visual-harmony-app.ts",
  "src/personal-visual-harmony.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
...
export const postgreSqlAuthorizationTransactionBoundaryChangedFiles = Object.freeze([
  "docs/decisions/2026-07-25-postgresql-authorization-transaction-boundary.md",
  "src/mcp/remote-http-authorization-data.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/remote-http-authorization-data.test.mjs",
...
export const railwayPostgreSqlSandboxVerticalSliceChangedFiles = Object.freeze([
...
export const sandboxQualificationLaunchGatesChangedFiles = Object.freeze([
  "bin/norma-core-sandbox-qualification.mjs",
  "docs/decisions/2026-07-25-sandbox-qualification-launch-gates.md",
  "docs/examples/sandbox-qualification-config.example.json",
  "docs/runbooks/sandbox-qualification-launch-gates.md",
  "qualification/sandbox-qualification.mjs",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/sandbox-qualification.test.mjs",
].sort());

export const railwayPostgreSqlSandboxAndQualificationChangedFiles = Object.freeze([
  ...new Set([
...
export const postgreSqlRuntimePoolWiringChangedFiles = Object.freeze([
  "bin/norma-core-remote-mcp-http.mjs",
  "docs/decisions/2026-07-25-railway-postgresql-sandbox-vertical-slice.md",
  "docs/runbooks/sandbox-qualification-launch-gates.md",
  "package-lock.json",
...
export const oauthImmediateRevocationLiveProofTruthSyncChangedFiles = Object.freeze([
  "docs/runbooks/oauth-immediate-revocation-sandbox.md",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
].sort());
...
export const pr261RemoteMcpOAuthToolSecurityChangedFiles = Object.freeze([
  "src/mcp/remote-http-server.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/mcp-remote-http-runtime.test.mjs",
...
export const pr263ScalekitIssuerCompatibilityChangedFiles = Object.freeze([
  "src/mcp/remote-http-auth.ts",
  "src/mcp/remote-http-config.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
...
export const pr264ScalekitCompositeAudienceChangedFiles = Object.freeze([
  "src/mcp/remote-http-auth.ts",
  "tests/changed-file-guard.mjs",
  "tests/changed-file-guard.test.mjs",
  "tests/mcp-remote-http-auth.test.mjs",
