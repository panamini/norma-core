...
state.automaticPreviewStale=false;
...
function reviewEditingBlocked(){return state.completed||state.confirming||multiPerceptionReviewLocked()||!state.imageReady}
