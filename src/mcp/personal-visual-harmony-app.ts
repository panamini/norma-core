...
function findPerceptionJob(value,depth=0){if(depth>7||value===null||typeof value!=="object")return null;if(typeof value.jobId==="string"&&typeof value.state==="string"&&typeof value.expiresAt==="string")return value;for(const entry of Object.values(value)){const found=findPerceptionJob(entry,depth+1);if(found)return found}return null}
