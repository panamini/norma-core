...
.measurement-ratio{margin:0 12px 10px;border:1px solid var(--rule);border-radius:2px;background:var(--white)}.measurement-ratio-toggle{border:1px solid var(--ink);border-radius:2px;background:var(--ink);color:var(--white);font-family:var(--body);font-size:13px;font-weight:600}.measurement-ratio-toggle[aria-pressed="false"]{border-color:var(--ink);background:var(--white);color:var(--graphite)}.measurement-ratio-toggle:hover:not(:disabled){background:var(--paper-hover);color:var(--ink)}.measurement-ratio-toggle[aria-pressed="true"]:hover:not(:disabled){background:var(--ink);color:var(--white)}.measurement-ratio select{border:1px solid var(--rule);border-radius:2px;background:var(--white);color:var(--ink);font-family:var(--body);font-size:11px}.measurement-ratio-note{color:var(--graphite);font-size:10px}
</style>
</head>
<body>
<main class="shell">
