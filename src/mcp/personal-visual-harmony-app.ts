        ...
        _meta: {
          normaPersonalVisualHarmony: {
            ...
            observability: {
              ...
              correlationId: prepared.prepared.candidateSetIdentity,
              handler: "prepare",
              handlerEnteredAtMs,
              handlerCompletedAtMs,
              handlerDurationMs: Math.max(0, handlerCompletedAtMs - handlerEnteredAtMs),
            },
          },
        },
      };
      ...
      return {
        ...
        _meta: {
          normaPersonalVisualHarmony: {
            ...
            observability: {
              contractId: PERSONAL_VISUAL_HARMONY_OBSERVABILITY_CONTRACT_ID,
              correlationId: candidateSetIdentity,
              handler: "confirm",
              handlerEnteredAtMs,
              handlerCompletedAtMs,
              handlerDurationMs: Math.max(0, handlerCompletedAtMs - handlerEnteredAtMs),
