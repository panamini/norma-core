...
window.addEventListener("openai:set_globals",()=>{const payload=currentPayload();if(payload&&payload.stage==="completed"&&!state.completed)renderResult(payload,window.openai?.toolOutput)});
hydrate();
</script>
</body>
</html>`;
